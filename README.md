...
Part 5 原图关联与残缺题干检查见 [Part 5 修复流程](docs/PART5_RECOVERY_PIPELINE.md)；辅助内容恢复和本轮已修复/待补齐范围见 [内容复核工作流](docs/CONTENT_REVIEW_WORKFLOW.md)。标记为待补齐的内容不会显示旧的英文注释或通用模板解析。
